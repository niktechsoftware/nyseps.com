...
function map_picker_initialize() {
    var markers = [];
	var lat = jQuery('#noo_event_google_map').attr('lat-data');
	var lng = jQuery('#noo_event_google_map').attr('lng-data');
    var myPlace = new google.maps.LatLng(parseFloat(lat), parseFloat(lng));
