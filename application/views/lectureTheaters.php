<?php $this->load->view('header'); ?>   
	 ...
	 <section id="page_detail_contaner" class="page_detail_container">
          <div class="row">
              <div class="container" style="background: url('<?php echo base_url();?>assets/sites/default/files/lecrutet.jpg'); height: 400px;">
                   <h2 class="page__slogan title" id="page-slogan">Lecture Theaters</h2>                                  
                </div>
...
<section id="page_detail_contaner" class="page_detail_container">
	...
	<p class="clearfix"></p>
    <div class="col-sm-4">
    	<img src="<?php echo base_url();?>assets/sites/default/files/lecture.jpg"  alt=""/>
    </div>
