          ...
          <div class="container-boxed max">
              <div class="col-md-8 col-sm-12">
                  <hr class="noo-gap noo-gap-100">
                      ...
                      <h2 class="custom-title"><span>Welcome to </span>NYSEPS</h2>
                                           	<p>Nice Yog Shikshan Evam Prashikshan Sansthan is founded and run by Nuva of Computer education Society, An Autonomous Body registered by Govt. of UP  under SR Act, 1860, and affiliated with various Govt. and Non-Govt. organizations to run respective professional and vocational training couses. Nuva of Computer education Society is working last 19 year in various fields social work like Education, Yoga & Wellness, Environment and poverty elimination etc.</p>
<p>Education takes place when, the person is open to any new learning experience at any age, time and place with an open mind. </p>                                          </div>
...
<div class="panel-separator"></div><div class="panel-pane pane-views pane-class"  >
        ...
        <div class="container-boxed max">
                <div class="row our-class-header">
                    <div class="col-md-12">
                        <div class="text-block">
                            <h2 class="custom-title"><span>Our </span>Courses</h2>
                                                    </div>
                    </div>
                </div>
              </div>
    ...
    <div class="item-wrap">
        ...
        <div class="item-content">
            <h3 class="item-title">
                <a href="class/vinyasa-class.html" title="">Code: PGDY 	</a>
            </h3>
            <div class="info">
                <span class="time"><span class="date-display-single" property="dc:date" datatype="xsd:dateTime" content="2015-08-18T12:00:00+07:00">Duration 15 Months	</span></span>
                <span>	Eligibility : <em>Graduation</em></span>
            </div>
    ...
    <div class="item-wrap">
        ...
        <div class="item-content">
            <h3 class="item-title">
                <a href="class/basic-kundalini.html" title="">Code: DY </a>
            </h3>
            <div class="info">
                ...
                <span>Eligibility :<em> 10+2 or Eq.</em></span>
            </div>
            <div class="learn-more">
                <a class="btn-darker" href="#" title="Learn more">Learn more </a>
            </div>
...
<div class="loop-item col-sm-6" style="background: #f9fffd; border: 1px solid #0288cc; border-radius: 15px;  -moz-border-radius: 15px;  -webkit-border-radius: 15px;">
   
        <img src="<?php echo base_url();?>assets/webimage/yogabenefit.png" alt="girl-1" class="image">
