<?php $this->load->view('header'); ?>   
	 ...
	 <section id="page_detail_contaner" class="page_detail_container">
          <div class="row">
              <div class="container" style="background: url('<?php echo base_url();?>assets/sites/default/files/terigensis.jpg'); height: 400px;">
                   <h2 class="page__slogan title" id="page-slogan">GENESIS & GROWTH OF TERI</h2>                                  
                </div>
	...
	<p class="clearfix"></p>
    <div class="col-sm-5">
    	<img src="<?php echo base_url();?>assets/sites/default/files/genesis.jpg" width="100%" alt=""/>
    </div>
    <div class="col-sm-7">
            	<p align="justify">
                 Technical Education and Research Institute was established as an appendage of post-graduate college which has an illustrious history of nearly five decades.The college has been the linechpin of higher education in eastern U.P a region hitherto plagued by economic backwardness for several unfortunate reasons.All the adversities not withstanding,the college has served as an academic womb for countless dignitaries who has embellished the intellectual environment in Indian and abroad.The college has been catering to the disparate academic needs of the society by offering a wide range of disciplines art, science, education,agricultural science,music,enviromental sciences,physical education,etc.at both graduate and post-graduate levels.  </p>
